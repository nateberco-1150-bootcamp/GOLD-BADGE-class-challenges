...
const section = document.getElementById("quotes"); // OR const section = document.querySelector("#quotes") 
...
.then(json => displayResults(json)); //chained promise resolvers (this line is a fat arrow version)
...
function displayResults(quote){
    ...
    section.appendChild(heading); //puts h1 element in our section variable (above)
    section.appendChild(img); //appends image to div
